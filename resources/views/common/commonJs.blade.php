<script type="text/javascript" src="{{asset('static/js/libs/jquery-1.10.2.min.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js')}}"></script>
<script type="text/javascript" src="{{asset('bootstrap/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('static/js/libs/lodash.compat.min.js')}}"></script>
<!--[if lt IE 9]>
    <script src="{{asset('static/js/libs/html5shiv.js')}}"></script>
<![endif]-->
...
<script type="text/javascript" src="{{asset('static/js/libs/breakpoints.js')}}"></script>
...
<script type="text/javascript" src="{{asset('plugins/typeahead/typeahead.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('plugins/datatables/tabletools/TableTools.min.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/datatables/colvis/ColVis.min.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/datatables/columnfilter/jquery.dataTables.columnFilter.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/datatables/DT_bootstrap.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/datatables/responsive/datatables.responsive.js')}}"></script>
...
<script type="text/javascript" src="{{asset('static/js/plugins.js')}}"></script>
<script type="text/javascript" src="{{asset('static/js/plugins.form-components.js')}}"></script>
<script>
...
<script type="text/javascript" src="{{asset('static/js/custom.js')}}"></script>
<script type="text/javascript" src="{{asset('static/js/demo/form_components.js')}}"></script>