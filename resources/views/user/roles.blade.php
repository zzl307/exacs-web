				...
				<div class="widget-header">
					...
					<div class="toolbar no-padding">
						<div class="btn-group">
							...
							<a data-toggle="modal" href="#addRoleModal" class="btn btn-xs">
								<i class="icon-plus">
								</i>
								新增
							</a>
						...
						<tbody>
							@foreach($roles as $vo)
								<tr>
									...
									<td>
										<a href="javascript:;" onclick="setRolePermissions('{{ $vo->id }}', '{{ $vo->name }}')" title="设置角色权限">
											<i class="icon-plus">
											</i>
										</a>
										&nbsp;
										<a href="javascript:;" onclick="editRole('{{ $vo->id }}')" title="修改角色内容">
											<i class="icon-edit">
											</i>
										</a>
										&nbsp;
										<a href="{{ url('user/role/delete?id='.$vo->id) }}" onclick="if(confirm('{{"确定删除角色".$vo->name."?"}}') == false) return false;" title="删除角色">
											<i class="icon-trash">
											</i>
										</a>
									</td>
